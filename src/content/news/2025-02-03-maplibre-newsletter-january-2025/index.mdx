...
authors: [bart, birk, ianthetechie, yuri, harel, brandon, josxha, ramyaragupathy]
draft: false
---
...
Here's the round-up of updates from January 2025! 
...
The year started with a bang 🎉. With the [release of the globe](https://github.com/maplibre/maplibre-gl-js/releases/tag/v5.0.0) almost on New Year's eve we were off to a great start in 2025. A very important discussion started with the release of version 5 and the change we decided to do with `geometry-type`, which led to the trust of 5.0.1 soon after and the reversion of a breaking change in the style. 
