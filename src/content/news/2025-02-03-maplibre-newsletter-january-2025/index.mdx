...
The year started with a bang 🎉. With the [release of the globe](https://github.com/maplibre/maplibre-gl-js/releases/tag/v5.0.0) almost on New Year's eve we were off to a great start in 2025. One breaking change related to `geometry-type` in the style spec caused a lot of important discussion, resulting in a quick revert of that specific change as 5.0.1.
While this discussion was valuable we encourage the community to use our pre-releases for major version and provide feedback before the official release.
