...
Hi everyone, I have been working on DuckDB support for [Martin](https://github.com/maplibre/martin) as part of Google Summer of Code, under the mentorship of [Frank Elsinga](https://github.com/CommanderStorm).
Martin already serves vector tiles from PostGIS, from pre-generated archives such as PMTiles and MBTilles, can extract images from COG and convert geojson to vector tiles on the fly.
This project adds a path for serving tiles directly from analytical datasets like GeoParquet directly via DuckDB.
...
<figure>
  <Image
    ...
    style="max-width: 520px; width: 85%; height: auto; display: block; margin: 0 auto;"
  />
