...
authors: [bart-louwers, harel-mazor]
draft: false
---

import { Image } from "astro:assets";
import meta from "./Meta.png";
import pitchlarger90degrees from "./pitchlarger90degrees.png";
...
<a href="https://www.meta.com/">
  <Image src={meta} alt="Meta sponsorship" style="width:100%; height: auto;" />
</a>
<br />
<br />
...
<a href="pitchlarger90degrees.png">
  <Image
    src={pitchlarger90degrees}
    alt="pitchlarger90degrees"
