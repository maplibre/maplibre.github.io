...
authors: [oliver-wipfli, yuri-astrakhan, bart-louwers]
draft: false
---
...
<a href="https://pheonor.github.io/globe-demo/">
  <Image
    alt="globe"
    src={globe}
    height="1000"
...
<i>
  Globe view proof of concept by Vivan Larrieu. Link:
  https://pheonor.github.io/globe-demo/.
</i>
...
[State of the Map Europe](https://stateofthemap.eu/) was held the 10-12th of November, 2023 in Antwerp. [Luke Seelenbinder](https://maplibre.org/about/luke-seelenbinder/) and [Bart Louwers](https://maplibre.org/about/bart-louwers/) represented the MapLibre team at the event and gave a talk to spread the word about MapLibre.
...
<i>
  SotM EU speakers. From left to right: Bart Louwers, Luke Seelenbinder, Jonas
  Vautherin.
</i>
