...
authors:
  [bart-louwers, harel-mazor, joscha-eckert, robin-boldt, ramya-ragupathy]
draft: false
---

import { Image } from "astro:assets";
import flutter from "./flutter-survey-results.png";

November month has seen a lot of updates from across different projects in Maplibre ecosystem. From multiple pre-releases for MapLibre GL JS and to groundbreaking updates in Maplibre Native, there's a lot to explore.
