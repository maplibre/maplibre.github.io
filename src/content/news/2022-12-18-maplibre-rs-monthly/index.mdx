...
In late summer, [@Drabble](https://github.com/Drabble) already started working
...
etc.) the required design changes will be uncovered.
<figure>
  <Image
...
In parallel [@Quillasp](https://github.com/Quillasp) worked on adding raster
...
WebWorkers. In the future, the browser should be tasked with the decoding jobs.
