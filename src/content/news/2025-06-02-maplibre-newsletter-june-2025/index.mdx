...
**New Hosted Project:** [MapLibre for Compose Multiplatform](https://github.com/maplibre/maplibre-compose) has officially been onboarded as a [hosted project](https://github.com/maplibre/maplibre/issues/441), marking another step forward in expanding the MapLibre ecosystem.
