...
**Plugin Layers are coming:** A major step towards customizability, plugin layers will soon allow developers to register custom layers with their own style spec extensions. The [design proposal](https://github.com/maplibre/maplibre-native/blob/main/design-proposals/2025-05-08-plugin-layers.md) was merged this month, and the [implementation PR](https://github.com/maplibre/maplibre-native/pull/3430) led by _Malcolm Toon of HudHud_, is nearing completion. HudHud also released their [navigation app](https://apps.apple.com/us/app/hudhud-maps/id6477774492) this month, which showcases MapLibre Native in production.

Note: The first version of plugin layer is _**iOS only**_ and comes with a few limitations.

- Custom layers do not have access to built-in data sources.
- Developers must interact with low-level graphics API (e.g. Metal) directly.
- Platform specific rendering like Drawables cannot be used.
- Lastly, plugin layers cannot participate in label placement.

<br></br>
Despite these constraints, this marks a solid functional foundation. Further
capabilities can be added incrementally based on community needs. Plugin
extendability is something that was often discussed the last few years, and it
is great to see a functional and pragmatic implementation becoming reality.
Malcolm also shared an impressive GLTF model loading plugin as a proof of
concept.
...
**New Team Member:** We are also thrilled about <a href="about/marc" target="_blank">Marc Wilson</a> joining our team as our new Graphics Engineer 🎉! Marc brings deep expertise in rendering and graphics, and we’re excited to see the impact he’ll have on MapLibre GL JS and beyond.

**New Hosted Project:** [MapLibre Compose](https://github.com/maplibre/maplibre-compose) has officially been onboarded as a [hosted project](https://github.com/maplibre/maplibre/issues/441), marking another step forward in expanding the MapLibre ecosystem.
