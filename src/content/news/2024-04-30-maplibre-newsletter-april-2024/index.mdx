...
authors: [oliver-wipfli, harel-mazor, bart-louwers, robin-boldt]
draft: false
---

import globe from "./globe-with-atmosphere.jpg";
import mappedin from "../../../../public/img/mappedin-logo.svg";
...
<i>
  A MapLibre raster tile globe with an atmosphere layer. See [source
  code](https://github.com/maplibre/maplibre-gl-js/pull/4020).
</i>
