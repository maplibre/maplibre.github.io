...
authors: [oliver-wipfli, harel-mazor, bart-louwers, patrick-wolowicz]
draft: false
---

import jawg from "./maplibre-jawg-logo.svg";
import newGif from "./new.gif";
import oldGif from "./old.gif";
...
<a href="https://www.jawg.io/en/">
  <Image src={jawg} alt="Jawg sponsorship" style="width:100%; height: auto;" />
</a>
<br />
<br />
