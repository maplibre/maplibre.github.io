...
import image from "./mlug-jp_logo.png";
...
<Image src={image} alt="Logo MapLibre User Group Japan" style="height:100%;max-width:600px;width:100%;display:block;margin:0px auto;" />
</p>
<br />
