...
- [Chris Beddow](https://www.linkedin.com/in/cbed/) organized a great meetup for everybody interested in maps in Meta's Zurich office. Among several other talks, [Bart Louwers](https://maplibre.org/about/bart-louwers/) gave a talk about the past, present, and future of MapLibre Native. [Manuel Roth](https://www.linkedin.com/in/manuel-roth/) from the Swiss TV broadcaster SRF gave a talk about how they use MapLibre GL JS and MapLibre Native for the weather app SRF Meteo. Thank you both for the inspiring presentations!
...
[Oliver Wipfli](https://maplibre.org/about/oliver-wipfli) and members of the MapLibre community will attend the [2023 Joint OGC-ASF-OSGeo Code Sprint](https://developer.ogc.org/sprints/20/) in Lausanne, Switzerland on **April 25th - 27th, 2023**. The topic of the code sprint is "Open Standards and Open Source Software" and we will discuss how the MapLibre Style Specification and the MVT Specification might be improved in the future. You can attend this code sprint in person or also fully remote. Feel free to join us in Lausanne and [register now](https://portal.ogc.org/public_ogc/register/230425osos_codesprint.php).

[Yuri Astrakhan](https://maplibre.org/about/yuri-astrakhan/), member of the MapLibre Governing Board, plans to attend [State of the Map US](https://2023.stateofthemap.us/) in Richmond, Virginia **June 8th - 11th, 2023**. Come to SotMUS and meet us there!
