...
A big thanks to [Birk Skyum](https://maplibre.org/about/birk-skyum/), [Frank Elsinga](https://maplibre.org/about/frank-elsinga/) and [Yuri Astrakhan](https://maplibre.org/about/yuri-astrakhan/) for their continued leadership, contributions, and support in driving these initiatives forward. 🙌
...
- Java: encoder (research quality)
- C++: decoder (in progress, targeting production quality)
- JavaScript: decoder (research quality)
- Rust: encoder and decoder (research quality)
