...
import npm200k from "./npm-200k.png";
import tileBounds from "./tile-bounds.png";
...
<a href="https://github.com/maplibre/maplibre-style-spec/issues/60">
  <Image src={tileBounds} alt="tile bounds" style="width:100%; height: auto;" />
</a>

<i>
  Some data sources like traffic have non-global coverage. To avoid loading
  empty tiles, we want to introduce more complex source tile bounds in the
