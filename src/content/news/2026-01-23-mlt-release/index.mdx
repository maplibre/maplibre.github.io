...
large (planet-scale) 2D and 2.5 basemaps. This current implementation offers feature parity with MLT while delivers on the following:
...
In addition, MLT was designed to support the following use cases:
...
As with any MapLibre project, the future of MLT is decided by the needs of the community. There are a lot of exciting ideas for future extensions and we welcome contributions to [the project](https://github.com/maplibre/maplibre-tile-spec).
...
We would love to hear your experience with using MLT! Join the `#maplibre-tile-format` channel on [our Slack](https://maplibre.org/community) or create an Issue or Discussion the [tile spec repo](https://github.com/maplibre/maplibre-tile-spec). 
