...
- You can also try out the [encoding server](https://github.com/maplibre/maplibre-tile-spec/tree/main/java/encoding-server) which converts existing (MVT based) styles and vector tile sources to MLT on the fly. This is mostly a tool for development.
...
Special thanks goes to Markus Tremmel for inventing the format, Yuri Astrakhan for spearheading the project, Tim Sylvester for the C++ implementation, Harel Mazor, Benedikt Vogl and Niklas Greindl for working on the JavaScript implementation.
